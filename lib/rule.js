...
import {
    ...
    RequiredParameter, ValueError, re, isArrayOfAtLeastOne
} from './utils.js';
            ...
            if (typeof v === 'function'){
                try {
                    var res = v.bind({
                        ...
                        selector: Object.assign(Object.create(null), this.selector, variables)
                    })();
                ...
                props[property] = v.replace(expression, function (substring, m1, m2, m3, start) {
                    var expr = m1 || m2 || m3;
                    try {
                        var fn = new Function((expr.search(/return\s/) !== -1) ? expr : 'return ' + expr).bind({
                            ...Object.assign(Object.create(null), props),
                            selector: Object.assign(Object.create(null), this.selector),
                            ...variables
                        });
                        return fn().toString();
                    } catch (err) {
    ...
    render(abbr, properties, { prefix = '', pretty = true } = {}) {
        ...
        var props = this.#resolveExpressions(
                this.#resolveTemplateVars(
                    Object.assign({abbr}, vars, properties), this.props, unresolved), errors, {classnames});
